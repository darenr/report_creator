...
class ReportCreator:
    ...
    Args:
        ...
        code_theme (str, optional): The code theme to use for the report. Defaults to "ir-black".
    ...
    def __init__(
        ...
        *,
        ...
        code_theme: Optional[str] = "ir-black",
        ...
        if github_handle:
            logging.info(f"GitHub: {github_handle}")
            self.header_str = f"""<img src="https://avatars.githubusercontent.com/{github_handle}?s=125" style="border-radius: 50%;">"""
        else:
