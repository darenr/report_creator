...
if __name__ == "__main__":
    ...
    fig_time = px.line(
        requests_over_time, x="dt", y="count", title="Hourly Traffic", markers=True
    )
    ...
    fig_status = px.pie(
        status_counts, values="count", names="status", title="Status Code Distribution"
    )
